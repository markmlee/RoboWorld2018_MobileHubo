...
public:
    ...
    void setupUi(QDialog *OmniWheelDialog)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 330, 192, 31));
        ...
        OW_LABEL_4 = new QLabel(OmniWheelDialog);
        OW_LABEL_4->setObjectName(QStringLiteral("OW_LABEL_4"));
        OW_LABEL_4->setGeometry(QRect(20, 230, 61, 21));
        OW_EDIT_TIME = new QLineEdit(OmniWheelDialog);
        OW_EDIT_TIME->setObjectName(QStringLiteral("OW_EDIT_TIME"));
        OW_EDIT_TIME->setGeometry(QRect(90, 230, 61, 23));
    ...
    void retranslateUi(QDialog *OmniWheelDialog)
    {
        ...
        OW_LABEL_4->setText(QApplication::translate("OmniWheelDialog", "Time(sec)", 0));
        OW_EDIT_TIME->setText(QApplication::translate("OmniWheelDialog", "0", 0));
    } // retranslateUi
