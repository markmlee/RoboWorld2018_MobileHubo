...
""));
        ...
        groupBox->setGeometry(QRect(520, 260, 231, 301));
...
""));
        ...
        BTN_EXECUTE_COMMAND->setGeometry(QRect(10, 260, 211, 31));
        ...
        RB_SW_NON_COMP->setGeometry(QRect(120, 130, 91, 22));
        ...
        line_4->setGeometry(QRect(10, 114, 111, 16));
        line_4->setFrameShape(QFrame::HLine);
        line_4->setFrameShadow(QFrame::Sunken);
        line_5 = new QFrame(groupBox);
        line_5->setObjectName(QStringLiteral("line_5"));
        line_5->setGeometry(QRect(10, 184, 111, 16));
        ...
        RB_JOINT_RECOVER->setGeometry(QRect(120, 230, 91, 22));
