...
#define MOBILE_LEFT_ARM



enum _SET_JointSequentialNumber_0{
    S_LSP = 0, S_LSR, S_LSY, S_LEB, S_LWY, S_LWP, S_LWY2, S_LHAND, S_NUM_2
};
enum _SET_JointSequentialNumber_1{
    S_RHW = 0, S_LHW, S_BHW, S_WST, S_NUM_1
};
enum _SET_JointSequentialNumber_2{
    S_RSP = 0, S_RSR, S_RSY, S_REB, S_RWY, S_RWP, S_RWY2, S_RHAND, S_NUM_0
};
...
const struct {
    ...
    {-1, 0}, {-1, 1}, {-1, 2}, {-1, 3}, { 1, 2}, {-1, 5},
    {-1, 0}, {-1, 1}, {-1, 2}, {-1, 3}, {-1, 0}, {-1, 5},
...
void SettingDialog::on_BTN_MOVE_JOINT_clicked(){
    ...
    if(lastSelected == RWH || lastSelected == LWH || lastSelected == BWH)
        angle /= 200.0;
